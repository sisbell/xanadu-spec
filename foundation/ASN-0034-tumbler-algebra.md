> **ASN-0034 · Tumbler Algebra** — Foundation layer  
> **Depends on:** _(none — root of the DAG)_  
> [Condensed statements →](ASN-0034-tumbler-algebra.statements.md) · [↑ Foundation index](README.md) · [↑ Spec home](../README.md)
